...
import advent.of.code.day25.Day25;
...
public class HttpRunner {
    public void run() throws IOException {
        ...
        server.createContext("/day/14/part1/", handler(Day14::part1));
        server.createContext("/day/14/part2/", handler(Day14::part2));
        server.createContext("/day/15/part1/", handler(Day15::part1));
        server.createContext("/day/15/part2/", handler(Day15::part2));
        server.createContext("/day/16/part1/", handler(Day16::part1));
        server.createContext("/day/16/part2/", handler(Day16::part2));
        server.createContext("/day/17/part1/", handler(Day17::part1));
        server.createContext("/day/17/part2/", handler(Day17::part2));
        server.createContext("/day/18/part1/", handler(Day18::part1));
        server.createContext("/day/18/part2/", handler(Day18::part2));
        server.createContext("/day/19/part1/", handler(Day19::part1));
        ...
        server.createContext("/day/22/part1/", handler(Day22::part1));
        server.createContext("/day/22/part2/", handler(Day22::part2));
        server.createContext("/day/23/part1/", handler(Day23::part1));
        server.createContext("/day/23/part2/", handler(Day23::part2));
        server.createContext("/day/24/part1/", handler(Day24::part1));
        server.createContext("/day/24/part2/", handler(Day24::part2));
        server.createContext("/day/25/part1/", handler(Day25::part1));
        server.createContext("/day/25/part2/", handler(Day25::part2));
